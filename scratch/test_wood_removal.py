...
# Apply wood mask from y = 400 downwards to cover the left-side wood fragments too
pedestal_wood = np.zeros_like(wood_or_bright)
pedestal_wood[400:, :] = wood_or_bright[400:, :]
...
print("Sandal background removed successfully without wood block!")
